...
LIBS := core,core_bench,atdgen,ocaml-protoc,ocaml-protoc-yojson,bin_prot,ppx_bin_prot,ppx_deriving_yojson,ppx_deriving_protobuf,extunix,uint,ocplib-endian,res,capnp
